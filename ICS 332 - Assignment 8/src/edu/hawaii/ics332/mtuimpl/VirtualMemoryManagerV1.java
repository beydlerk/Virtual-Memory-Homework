...
/**
 *  Version V1 - Simple demand paging when memory size = disk size
 *  VirtualMemoryManagerV1 - virtual memory manager must implement demand paging.
 *	
...
public class VirtualMemoryManagerV1 extends MemoryTranslationUnit {
