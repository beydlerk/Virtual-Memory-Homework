...
/**
 *  Version V2 - Demand paging with FIFO page replacement
 *  VirtualMemoryManagerV2 - handle an address space that is larger than the main memory
 *	
...
public class VirtualMemoryManagerV2 extends MemoryTranslationUnit {
