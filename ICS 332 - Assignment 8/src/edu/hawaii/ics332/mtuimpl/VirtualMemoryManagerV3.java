...
/**
 *  Version V3 - Adding a dirty bit
 *  VirtualMemoryManagerV3 uses a dirty bit as part of the page table to avoid writing back to disk 
 *  those pages that have not been modified (whether when evicting or when writing all pages via the 
 *  writeBackAllPagesToDisk() method).
 *	
...
public class VirtualMemoryManagerV3 extends MemoryTranslationUnit {
